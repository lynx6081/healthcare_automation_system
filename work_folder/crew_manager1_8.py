...
class HealthCrewManager:
    ...
    def fallback_response(self, query: str) -> dict:
        ...
        elif any(word in query_lower for word in ['medical', 'doctor', 'health', 'lab', 'test', 'symptom']):
            content = "I understand you have a medical question. I'll connect you with Dr. Warren, our medical strategist, who can provide expert medical guidance based on your health profile and current research."
