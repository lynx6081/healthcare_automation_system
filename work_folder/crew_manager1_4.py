...
class HealthCrewManager:
    ...
    def setup_crew(self):
        ...
        try:
            ...
            self.crew = Crew(
                ...
                max_execution_time=60,  # 60 second timeout per task
            )
    ...
    def should_use_mock_response(self):
        ...
        return use_mock or api_limit_reached
    
    def classify_query(self, query):
        """Classify query type for mock responses and delegation"""
        query_lower = query.lower()
        
        if any(word in query_lower for word in ['doctor', 'medical', 'health', 'symptom', 'lab', 'test', 'diagnosis', 'medication']):
            return 'medical'
    ...
    def _execute_with_timeout(self, func, timeout_seconds=20):
